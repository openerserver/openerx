...
const errorMessages: Record<string, string> = {
  ...
  REMOTE_BIOMETRIC_REQUIRED: "当前电脑版本仍要求生物识别，请更新电脑端后重试。",
  REMOTE_DEVICE_UNLOCK_REQUIRED: "请解锁手机后重新点击审批。",
  REMOTE_REAUTHENTICATION_EXPIRED: "本次审批已过期，请刷新后重新点击。",
  REMOTE_PERMISSION_DECISION_NOT_ALLOWED: "此操作无法使用会话授权，请选择本次允许或完全允许。",
  PERMISSION_DECISION_NOT_ALLOWED: "此操作无法使用会话授权，请选择本次允许或完全允许。",
  PERMISSION_EXPIRED: "此审批已过期，请刷新任务后重试。",
  PERMISSION_ALREADY_RESOLVED: "此审批已处理，请刷新任务。",
  PERMISSION_PAYLOAD_CHANGED: "审批内容已变化，请刷新后重新核对。",
