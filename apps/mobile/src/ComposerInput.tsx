...
import { StyleSheet, Text, TextInput, type TextInputProps, type TextStyle, useWindowDimensions, View } from "react-native";
...
export const ComposerInput = forwardRef<TextInput, Props>(
  ({ value, style, ...props }, ref) => {
    ...
    const textStyle: TextStyle = {
      ...
      paddingLeft: inputStyle?.paddingLeft ?? inputStyle?.paddingHorizontal ?? inputStyle?.padding ?? 0,
      paddingRight: inputStyle?.paddingRight ?? inputStyle?.paddingHorizontal ?? inputStyle?.padding ?? 0,
    };
    return (
