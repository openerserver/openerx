...
export const KEY_FOREIGN_KEYS: ForeignKeyValidationRule[] = [
  ...
  { table: "project_tree_events", column: "node_id", targetTable: "project_tree_nodes" },
  { table: "project_tree_events", column: "project_id", targetTable: "projects" },
  ...
  { table: "agent_runs", column: "task_id", targetTable: "project_tree_nodes" },
  { table: "agent_runs", column: "run_id", targetTable: "task_runs" },
  { table: "agent_runs", column: "run_node_id", targetTable: "task_run_nodes" },
  ...
  { table: "task_run_nodes", column: "agent_run_id", targetTable: "agent_runs" },
