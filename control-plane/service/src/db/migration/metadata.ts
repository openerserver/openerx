...
export const KEY_FOREIGN_KEYS: ForeignKeyValidationRule[] = [
  ...
  { table: "tasks", column: "user_id", targetTable: "users" },
  { table: "tasks", column: "repo_id", targetTable: "repositories" },
  { table: "tasks", column: "credential_id", targetTable: "repository_credentials" },
  { table: "task_nodes", column: "task_id", targetTable: "tasks" },
  { table: "task_edges", column: "task_id", targetTable: "tasks" },
  { table: "task_edges", column: "from_node_id", targetTable: "task_nodes" },
  { table: "task_edges", column: "to_node_id", targetTable: "task_nodes" },
  { table: "agent_runs", column: "task_id", targetTable: "tasks" },
  { table: "agent_runs", column: "node_id", targetTable: "task_nodes" },
  { table: "code_changes", column: "task_id", targetTable: "tasks" },
  { table: "code_changes", column: "repo_id", targetTable: "repositories" },
  { table: "code_changes", column: "agent_run_id", targetTable: "agent_runs" },
  { table: "file_changes", column: "change_id", targetTable: "code_changes" },
  { table: "sessions", column: "project_id", targetTable: "projects" },
  { table: "sessions", column: "user_id", targetTable: "users" },
  ...
  { table: "task_workflow_runs", column: "task_id", targetTable: "tasks" },
  ...
  { table: "role_aggregate_conclusions", column: "task_id", targetTable: "tasks" },
  { table: "developer_change_requests", column: "task_id", targetTable: "tasks" },
  { table: "task_operating_modes", column: "task_id", targetTable: "tasks" },
  { table: "boss_decisions", column: "task_id", targetTable: "tasks" },
  { table: "human_escalations", column: "task_id", targetTable: "tasks" },
  ...
  { table: "project_task_relations", column: "project_id", targetTable: "projects" },
  { table: "project_task_relations", column: "source_task_id", targetTable: "tasks" },
  { table: "project_task_relations", column: "target_task_id", targetTable: "tasks" },
  { table: "runtime_usage_ledgers", column: "project_id", targetTable: "projects" },
  { table: "runtime_usage_ledgers", column: "task_id", targetTable: "tasks" },
  { table: "runtime_usage_ledgers", column: "agent_run_id", targetTable: "agent_runs" },
  { table: "runtime_usage_ledger_steps", column: "ledger_id", targetTable: "runtime_usage_ledgers" },
  { table: "runtime_usage_ledger_steps", column: "project_id", targetTable: "projects" },
  { table: "runtime_usage_ledger_steps", column: "task_id", targetTable: "tasks" },
  { table: "runtime_usage_ledger_steps", column: "agent_run_id", targetTable: "agent_runs" },
