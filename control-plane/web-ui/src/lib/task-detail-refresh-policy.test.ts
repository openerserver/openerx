...
describe("task detail refresh policy", () => {
  ...
  it("refreshes messages when a tool message update makes persisted tool output available", () => {
  ...
  it("refreshes messages when a user message update changes the visible conversation", () => {
