...
>
> 范围影响：本方案是对当前 V1 合同的增量提案；获批实施后，需要同步修订
> `00-product-decision-review.md`、`01-product-contract.md`、`03-experience-and-information-architecture.md`、
> `04-domain-and-api-contract.md`、`05-platform-and-pi-contract.md`、
> `06-security-and-governance-contract.md`、`08-acceptance-contract.md`、
> `10-codex-capability-baseline.md` 和 `14-overall-architecture.md`。
