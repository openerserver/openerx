...
- 托管 Chromium 和隔离 Profile 未实现。Firefox 当前明确不支持；如果 Firefox 或其他未支持浏览器是
  ...
  [Windows system browser](evidence/bcu-003-windows-system-browser-2026-08-29.md)。
...
- BCU-001 已同步修订此前把 Browser 写成“内嵌隔离浏览器”或“仅 BrowserWindow”的生效合同，包括
  `00-product-decision-review.md`、`01-product-contract.md`、`02-users-and-scenarios.md`、
  `03-experience-and-information-architecture.md`、`05-platform-and-pi-contract.md`、
  `06-security-and-governance-contract.md`、`08-acceptance-contract.md`、`09-golden-task-catalog.md`、
  `10-codex-capability-baseline.md`、`13-development-plan.md` 和 `14-overall-architecture.md`。历史
  `evidence/` 文档保持原样，继续描述当时实现，不能回写成新方案的完成证据。
