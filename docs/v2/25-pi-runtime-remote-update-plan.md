...
| 阶段 | 交付 | 退出条件 |
| --- | --- | --- |
| PIRU-001 Baseline | 在当前结构中把 Pi 更新到 `0.84.4`，完成专项兼容测试和日期化证据 | `LOCAL PASS`；依赖、Pi Host、Session/Tool/Compaction、真实 DeepSeek 和 Bundle 构建已验证，完整工作区例外见[日期化证据](evidence/pi-0.84.4-upgrade-2026-08-30.md)；尚不宣称远程更新或发布完成 |
