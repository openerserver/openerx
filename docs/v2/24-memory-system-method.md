...
1. **用户控制优先**：默认关闭；使用已有记忆与生成新记忆是两个独立权限。
...
- [真实模型 Golden/holdout 评测说明](evidence/memory-model-golden-evaluator-2026-08-30.md)
- [Fixed Golden 机器报告](evidence/memory-model-golden-fixed-2026-08-30.json)
- [Fixed holdout 机器报告](evidence/memory-model-holdout-fixed-2026-08-30.json)
- [同步收敛证据](evidence/memory-phase-b-sync-convergence-2026-08-30.md)
- [全目录语义轮转证据](evidence/memory-phase-b-semantic-cluster-rotation-2026-08-30.md)
