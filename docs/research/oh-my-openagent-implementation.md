...
详细现行方案见 [dag-node-execution-plan-v2.md](../workflow/dag-node-execution-plan-v2.md)。
...
因此本附录不再展开旧版文件级设计。当前有效实现与后续迭代方向，请以 [dag-node-execution-plan-v2.md](../workflow/dag-node-execution-plan-v2.md) 为准。
