...
> 日期：2026-03-29
> 作者：GitHub Copilot
> 关联文档：[task-session-message-minimal-contract.md](../task-domain/task-session-message-minimal-contract.md)、[task-session-message-service-route-dto-draft.md](../task-domain/task-session-message-service-route-dto-draft.md)、[task-session-message-roundtrip-target-plan.md](../task-domain/task-session-message-roundtrip-target-plan.md)、[task-detail-realtime-event-contract.md](task-detail-realtime-event-contract.md)
