...
2. ../control-plane/service/src/modules/tasks/task-conversation-session-sync.ts
说明：旧 session 写面，直接冲突于新 `task_sessions`。

3. ../control-plane/service/src/modules/tasks/task-run-write-sync.ts
说明：旧 run / run node 写面，必须删除。

4. ../control-plane/service/src/modules/tasks/task-conversation-message-sync.ts
...
2. ../control-plane/service/src/modules/tasks/task-domain-run-routes.ts
说明：`/domain-runs*` 必删。
...
1. ../control-plane/service/src/modules/tasks/task-conversation-session-sync.ts
2. ../control-plane/service/src/modules/tasks/task-run-write-sync.ts
...
1. [../control-plane/service/src/modules/tasks/task-domain-projector.ts](../../control-plane/service/src/modules/tasks/task-domain-projector.ts)
2. ../control-plane/service/src/modules/tasks/task-branch-compat-read.ts
