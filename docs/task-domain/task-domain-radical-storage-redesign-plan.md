...
- [execution-trace-read-boundary-adr.md](../architecture/execution-trace-read-boundary-adr.md)
...
- [architecture-target-evolution.md](../architecture/architecture-target-evolution.md)
...
评审与实现边界以 [execution-trace-read-boundary-adr.md](../architecture/execution-trace-read-boundary-adr.md) 为单一引用来源；本节只保留任务域收尾视角，不再重复展开最终 contract。
