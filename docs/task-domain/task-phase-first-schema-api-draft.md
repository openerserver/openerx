...
>
> 相关上下文：
> 1. [docs/task-session-first-schema-plan.md](task-session-first-schema-plan.md)
> 2. [docs/task-tree-data-model-replan.v2-final.md](task-tree-data-model-replan.v2-final.md)
