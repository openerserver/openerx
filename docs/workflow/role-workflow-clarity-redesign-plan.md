...
- [docs/workflow-template-stage-machine-design.md](workflow-template-stage-machine-design.md) 定义的是阶段状态机和阶段控制规则
- [docs/development-role-agents-plan.md](../organization/development-role-agents-plan.md) 定义的是研发过程中的职责角色体系
- [docs/bff-role-aggregation-executor-design.md](bff-role-aggregation-executor-design.md) 定义的是这些角色如何在 BFF 中被调度、聚合、冲突解析并转成治理结果
