...
files=(
  "tests/web-ui-bff/runtime-provider.test.ts"
  "tests/web-ui-bff/runtime-provider-pimono.test.ts"
  "tests/web-ui-bff/run-persistence-agent-runs.test.ts"
  "tests/web-ui-bff/runtime-pipeline.test.ts"
  "tests/web-ui-bff/opencode-adapter.test.ts"
  "tests/web-ui-bff/lifecycle-hooks-behavior.test.ts"
  ...
  "tests/web-ui-bff/task-list-snapshot-route.test.ts"
  "tests/web-ui-bff/task-member-view-route.test.ts"
  "tests/web-ui-bff/task-execute-stage-dispatch-route.test.ts"
  "tests/web-ui-bff/task-execution-trace-route.test.ts"
  "tests/web-ui-bff/task-reconcile.test.ts"
...
echo
echo "BFF mock batch 22 expanded summary: total=${#files[@]} failed=${#failed_files[@]}"

if ((${#failed_files[@]} > 0)); then
  echo "BFF mock batch 22 expanded failures:"
...
echo "BFF mock batch 22 expanded passed"
