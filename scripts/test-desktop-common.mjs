...
run(
  ...
  [
    ...
    "tests/clean-debug-artifacts.test.mjs",
...
run(vitest, [
  ...
  "packages/tool-sdk/tests/shell-adapter.test.ts",
  "packages/file-service/tests/file-service.test.ts",
  "tests/v2/golden/files-m4.test.ts",
